...
def linear_regression_vars(prices, v_bid, v_ask, s1, s2, s3):
    """Use the second time period to generate the independent and dependent variables
       in the linear regression model deltap = w0 + w1 *deltap1 + w2 * deltap2 + w3 * deltap3 + w4 * r.
    ...
    Returns:
        ...
        row represents [deltap1,deltap2 deltap3, r]. Y is a numpy array of floats and
        each array element represents deltap.
    """
...
def evaluate_performance(coin_amount, prices, dates, dps, t, step):
    """Use the third time period to evaluate the performance of the algorithm.

    Args:
        coin_amount: Quantiity of to operate
        prices: A numpy array of floats representing prices over the third time
            period.
...
def evaluate_performance2(coin_amount, prices, dates, dps, t, step):
    """Use the third time period to evaluate the performance of the algorithm.
